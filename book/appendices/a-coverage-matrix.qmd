...
- **R** is the reference implementation: every capability family, the full format set including `.rds` and gzipped CSV/TSV, the only generated reference site, and the only CI-gated test suite. Its version stamp is v0.7.0, level with Python. If a behaviour is ambiguous, R defines it.
