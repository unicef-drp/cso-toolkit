...
To cite a specific edition, append the version tag (e.g., `v0.5.0`) and use that release's **version DOI** rather than the always-latest **concept DOI**. Each tagged release has its own version DOI; the concept DOI always resolves to the most recent version.
